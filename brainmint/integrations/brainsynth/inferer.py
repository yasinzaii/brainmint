...
from brainmint.integrations.brainsynth.vendor_vqvae import VQVAEBase
...
class VQVAEDecodingInferer(Inferer):
    def __init__(
        ...
        """
        Args:
            num_quantization_levels (int): How many quantization levels the network has.
        """
        Inferer.__init__(self)

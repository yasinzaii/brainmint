...
class ControlNet(nn.Module):
    ...
    Args:
        ...
        additional_embedding_dim: additional embedding dimension to append to time embeddings.
    ...
    def __init__(
        ...
        additional_embedding_dim: int = 0,
        ...
        temb_channels = time_embed_dim + int(additional_embedding_dim)
